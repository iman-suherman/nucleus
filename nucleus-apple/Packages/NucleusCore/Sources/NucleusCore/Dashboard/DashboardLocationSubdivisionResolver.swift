...
public enum DashboardLocationSubdivisionResolver {
    public static func context(from placemark: CLPlacemark) -> DashboardLocationContext? {
    ...
    public static func subdivisionCode(countryCode: String, administrativeArea: String?) -> String? {
    ...
    public static func displayName(for subdivisionCode: String) -> String {
    ...
    public static func displayNames(for subdivisionCodes: [String]) -> [String] {
