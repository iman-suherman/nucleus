...
public struct DashboardPublicHolidayCountryOption: Identifiable, Equatable, Sendable, Codable {
...
public enum DashboardPublicHolidayCountryCatalog {
    ...
    public static func localizedCountryName(for countryCode: String) -> String {
        let normalized = countryCode.uppercased()
        return Locale.current.localizedString(forRegionCode: normalized) ?? normalized
    }

    public static func loadCachedCountries() -> [DashboardPublicHolidayCountryOption] {
        guard
    ...
    public static func fetchCountries() async -> [DashboardPublicHolidayCountryOption] {
