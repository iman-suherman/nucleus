...
public enum GoogleWebSignInURL {
    ...
    public static func signInURL(email: String, continue continueURL: URL, service: Service) -> URL? {
    ...
    public static func prefillEmailScript(email: String) -> String {
    ...
    public static func isGoogleSignInPage(_ urlString: String) -> Bool {
